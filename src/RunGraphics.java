...
public class RunGraphics {
    ...
    public static class showGraphics extends JPanel implements Runnable, KeyListener {
        ...
        public void paintComponent(Graphics g) {
            ...
            Dimension d = getSize();
            g2.setColor(new Color(250,250,51));
            ...
            if(running==true) {
            	...
            	g.drawString("Press Enter to Start the Game", (SCREEN_WIDTH - metrics.stringWidth("Press Enter to Start the Game"))/2, SCREEN_HEIGHT/2);
            }
